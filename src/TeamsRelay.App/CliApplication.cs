...
public sealed partial class CliApplication
{
    ...
    private readonly LifecycleStateStore _stateStore;
        ...
        IProcessOperations processOperations)
    {
        ...
        _configFiles = new ConfigFileService(environment);
        _stateStore = new LifecycleStateStore(RuntimePaths.Create(environment));
    }
    ...
    public async Task<int> RunAsync(IReadOnlyList<string> args, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            {
                _stdout.WriteLine($"teamsrelay {ApplicationVersion.Value}");
                return 0;
            }
        ...
        {
            _stderr.WriteLine($"Error: {exception.Message}");
